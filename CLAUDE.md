...
- **Activate (N)**: a repeatable, once-per-turn minion ability costing N Gold to trigger — introduced this patch; not yet wired into the Action Space (see Open Questions in CONTEXT.md)
